...
export default class NotifService {
  ...
  localNotif(soundName) {
    ...
    PushNotification.localNotification({
      ...
      // ticker: 'My Notification ', // (optional)
      autoCancel: true, // (optional) default: true
      largeIcon: 'ic_launcher', // (optional) default: "ic_launcher"
      smallIcon: 'ic_notification', // (optional) default: "ic_notification" with fallback for "ic_launcher"
      bigText:
        'Anda Telah Memesan Makanan di SmartCanteen, lihat My Order untuk Informasi Selengkapnya', // (optional) default: "message" prop
      subText: 'Anda Telah Memesan Makanan di SmartCanteen', // (optional) default: none
      ...
      title: 'Informasi Order Anda', // (optional)
      message: 'Anda Telah Memesan Makanan', // (required)
